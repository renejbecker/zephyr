...
static int eth_fake_bridge_addif(const struct device *dev, struct net_if *br __unused,
				 struct net_if *iface __unused)
{
	struct eth_fake_context *ctx = dev->data;
...
static int eth_fake_bridge_delif(const struct device *dev, struct net_if *br __unused,
				 struct net_if *iface __unused)
{
	struct eth_fake_context *ctx = dev->data;
...
static int eth_fake_bridge_start(const struct device *dev, struct net_if *br __unused,
				 struct net_if *iface __unused)
{
	struct eth_fake_context *ctx = dev->data;
...
static int eth_fake_bridge_stop(const struct device *dev, struct net_if *br __unused,
				struct net_if *iface __unused)
{
	struct eth_fake_context *ctx = dev->data;
...
static const struct ethernet_api eth_fake_api_funcs = {
	...
	.bridge_addif = eth_fake_bridge_addif,
	.bridge_delif = eth_fake_bridge_delif,
	.bridge_start = eth_fake_bridge_start,
	.bridge_stop = eth_fake_bridge_stop,
	.send = eth_fake_send,
};
