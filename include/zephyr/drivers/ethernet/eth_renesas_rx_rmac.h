...
#define RENESAS_RX_MPIC_LSC_10   0
#define RENESAS_RX_MPIC_LSC_100  1
#define RENESAS_RX_MPIC_LSC_1000 2

#define RENESAS_RX_ETHA_DISABLE_MODE   1
#define RENESAS_RX_ETHA_CONFIG_MODE    2
#define RENESAS_RX_ETHA_OPERATION_MODE 3
